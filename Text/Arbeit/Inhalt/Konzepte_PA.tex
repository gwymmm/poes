...
% charakteristiken: zeitbegrenzung, gegenseitig ausschließende und vollständige Antwortvarianten,
% subjektive Wahrscheinlichkeiten ergänzen sich zu 100%
}. Grundsätzlich sind alle Forecasting Exercises in ähnlicher Weise aufgebaut.
Das Beispiel zeigt einige Grundeigenschaften dieser Aufgaben. Zunächst ist
ein genaues Datum angegeben, an dem die Prognosen \glqq{fällig}\grqq{} werden. Ab
diesem Datum ist die Antwort auf die Frage bekannt und es kann geprüft werden,
ob und welche der Vorhersagen eingetreten sind. Zudem ist die Frage sehr präzise
gestellt, was ebenfalls der Überprüfbarkeit dient. Weiterhin schließen sich die
Antwortmöglichkeiten auf die Frage gegenseitig aus und es gibt keinen Wert der
nicht in eine der Antwortkategorien passt (Vollständigkeit). Schließlich ergänzen
sich die subjektiven Wahrscheinlichkeiten, die für die einzelnen Optionen vergeben
wurden, zu 100~\%.
