...
% TODO
% Data Mining Betonung von Big Data, 3 Vs
...
% TODO
% unstrukturiert, teilstrukturiert und strukturiert.
...
% verteilte Anwendungen, Cloud (Hadoop)
...
wird. % siehe 'Schlüsselideen der Wirtschaftswissenschaft'
}
...
kann dabei helfen, die Qualität von Entscheidungen zu verbessern.

Dabei eignet sich Forecasting besser für strategische und taktische Entscheidungen,
da auf operativer Ebene mehr Erfahrungswerte vorliegen, was den Nutzen von
...
Dokumente und erstellen sich auf dieser Basis einfache Modelle (siehe S.~\xcom).
...
Predictive Analytics wird hingegen typischerweise von ausgebildeten Spezialisten in Fächern wie
Mathematik, Statistik oder Informatik praktiziert (\cite{Gluchowski}, S.~107).
...
% Reaktionszeit Forecaster: Tage bis Wochen, PA: Monate bis Jahre.
...
narrative Regeln befolgt werden, mit denen das Urteilsvermögen verbessert werden kann (siehe Abschnitt~\xcom und % Grundprinzipien des Forecasting
Anhang~\xcom).
...
und mit Hilfe des Brier Score die Genauigkeit der Vorhersagen prüfen (siehe Anhang~\xcom). Ferner muss
