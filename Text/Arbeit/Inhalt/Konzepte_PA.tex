...
kleinen Menge an Überzeugungen ziehen. Zudem zeichnen sich \emph{hedgehogs}
durch einen geistigen \glqq{Geiz}\grqq (\emph{parsimony}) aus (vgl.
\cite{Tetlock}, S.~20). Dies bedeutet, dass sie nur ungerne neue Grundsätze
