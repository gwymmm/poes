...
% Wertebereich, was gut - schlecht
% Komponenten: Kalibirierung und Diskriminierung (von den Fähigkeiten des Prognostiker abhängige)
% zentrale KernIdee: große Zahlen
...
\caption{Leistungsunterschiede bei den \emph{forecasting exercises} in
  Abhängigkeit vom \emph{Style-of-Reasoning} der Teilnehmer}
