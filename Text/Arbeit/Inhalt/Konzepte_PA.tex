...
Bei Daten lassen sich verschiedene Typen\footnote{Auch als Skalen
(\emph{scales of measurement}) bezeichnet} unterscheiden.
...
ordnen. Es lässt sich lediglich feststellen, ob zwei nominal skalierte Variablen
...
dagegegen Vergleiche wie \glqq{München}\grqq$<$\glqq{Berlin}\grqq
