...
% Forecasting eher für strategische und taktische Entscheidungen
% auf operativer Ebene mehr Erfahrungswerte

% Forecasting für kleinere Gruppen (Unternehmen) bezahlbar, mit Taschenrechner machbar
% -> leichtere Methode 

% PA teuer (siehe Iffert, S. 22)
% Preise für Software-Lizenzen für Predictive Analytics so-
% wie die Kosten für Beratungsleistungen der Anbieter und Ser-
% vice-Dienstleister für viele Unternehmen schwer rechnen

% subjektive Wsk füllen Entscheidungsbaum (S. 319) und Entscheidungsmatrix

% Große Zahlen erforderlich

% Meisten nicht genügend Daten für PA

% Forecasting leichter zu verstehen, für jemanden der kein Studium in Mathe etc hat.
