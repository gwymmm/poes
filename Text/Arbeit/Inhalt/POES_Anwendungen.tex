...
Der \glqq{Bible Belt}\grqq{} ist eine besonders religiöse Region der USA, die sich über mehrere Bundesstaaten erstreckt.
...
zunehmend automatisiert wird. Allerdings ändert der externe Druck die \glqq{Spielregeln}\grqq{}, sodass
...
Allerdings sind solche Warnsysteme sehr arbeitsintensiv, da sie mit relevanten Texten trainiert werden, die per Hand
...
%im Bildungssektor präsentiert werden.
...
Konkrete Anwendungen, die Datenanalysen an Hochschulen unterstützen, werden auch als \emph{Predictive Learning Analytics} (PLA)
