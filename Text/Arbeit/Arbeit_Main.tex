...
\cite{Mauerer}, \cite{OECD}, \cite{Dinov}, \cite{Runkler}, \cite{McCarthy}

\cite{Crossman}, \cite{Bowles}

\cite{Arens}

Hier ist Etwas unbekanntes \xcom.

Verweise auf \gls{glos:PCA}. Und es geht weiter \gls{glos:PCA}. \gls{PCA} \gls{PCA}

\misobj{Tabelle mit Kram}
